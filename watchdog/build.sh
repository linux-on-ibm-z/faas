...
docker build --no-cache --build-arg PLATFORM="-s390x" -t openfaas/classic-watchdog:latest-dev-s390x . -f Dockerfile.packager
...
docker cp buildoutput:/go/src/github.com/openfaas/faas/watchdog/watchdog-s390x ./fwatchdog-s390x
